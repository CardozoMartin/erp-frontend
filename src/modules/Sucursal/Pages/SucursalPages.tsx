  ...
  return (
    <>
      <header className="top-16 z-10 bg-[#fbf9fa] border-b border-[#c4c6cd] px-6 py-3 flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-semibold tracking-tight text-[#041627]">Sucursales</h2>
          <p className="text-sm text-[#5f6771] mt-1">Administra las sucursales disponibles para stock y operaciones.</p>
        </div>
      ...
      <div className="max-w-[1280px] mx-auto px-6 py-6 flex flex-col gap-6">
        <section className="bg-white border border-[#c4c6cd] rounded-xl shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-[#c4c6cd] bg-[#fbf9fa]">
            <h3 className="text-lg font-semibold text-[#041627]">Lista de sucursales</h3>
          </div>
          {isLoading ? (
            <div className="px-6 py-8 text-center text-[#44474c]">Cargando sucursales...</div>
          ) : (
        ...
        <div className="flex justify-between items-center text-[#44474c]">
          <span className="text-sm">Mostrando {sucursales.length} de {total} sucursales</span>
