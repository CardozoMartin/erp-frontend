  ...
  return (
    <>
      <header className="top-16 z-10 bg-[#fbf9fa] border-b border-[#c4c6cd] px-6 py-3 flex items-center justify-between">
        ...
        {tiene('sucursales.crear') && (
          <button
            onClick={() => navigate('/sucursales/nuevo')}
            className="px-4 py-2 text-sm font-medium bg-[#075E54] hover:bg-[#1e8e4f] text-white rounded-sm transition-colors flex items-center gap-2 cursor-pointer"
          >
