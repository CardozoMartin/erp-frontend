  ...
  return (
    <>
      ...
      >
        ...
        {/* Nombre */}
        <td className="px-6 py-4">
          <p className="text-[15px] font-semibold text-[#041627] leading-tight">
            {product.nombre}
          </p>
        ...
        {/* SKU */}
        <td className="px-6 py-4 text-[13px] text-[#44474c] font-mono">
        ...
        <td className="px-6 py-4">
          {(() => {
            ...
            const badgeClass =
              categoryBadge[categoryName as CategoryType] ||
              "bg-[#e8edf5] text-[#34495e]";
        ...
        createPortal(
          ...
          >
            ...
            >
              ...
              <span className="text-[11px] bg-amber-100 text-amber-700 px-2 rounded-full">
                %
              </span>
            </button>
